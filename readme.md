...
To view the website, 
* click [Python Django Blog Website](https://github.com/prodip36/Python-Django-Blog-Website-main)
or 
* copy the link https://github.com/prodip36/Python-Django-Blog-Website-main paste it to your browser and load it.  
